# Claude Code Instructions — Spring Boot 3
...
**Stack**: `java-spring-boot-3` — Spring Boot 3 (framework `spring-boot` `3.2.0`).

**Rule count**: 17 rule(s) opt into Claude Code for this stack.
...
**You MUST: Mandatory @Valid and @Validated on Controller Boundaries.**
...
**You MUST: Mandatory Request and Response Record Types at the Controller Boundary.**
...
**You MUST: RFC 7807 ProblemDetail as the Wire Format on Spring Boot 3+.**
